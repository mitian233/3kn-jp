            ...
            <div class="flex flex-col md:flex-row md:justify-between">
                ...
                >
                    <div id="blog" class="hero-link">
                        <a href="https://blog.bangdream.moe" class="super-link"
                            >Blog</a
                        >
                    </div>
                    ...
                    <div id="x" class="hero-link">
                        <a href="https://x.com/mikan_chn" class="super-link"
                            >X/Twitter</a
                        >
                    </div>
                </div>
                ...
                <table class="w-full border-separate">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="md:text-justify">
                                <p>
                                    Third-rate University student. Who's coding
                                    skills is all self-taught. Excel at
                                    transforming design concepts into responsive
                                    web applications. With a meticulous eye for
                                    detail and a dedication to clean code, can
                                    actively contribute to open-source projects,
                                    pushing the boundaries of web development.
                                    Advocating for accessibility and usability,
                                    who strive to create inclusive digital
                                    experiences. Committed to collaboration, who
                                    stay updated on emerging technologies,
                                    continually enhancing whose skills to make
                                    meaningful contributions to the dynamic
