...
onMounted(() => {
  ...
  text.add(
    gsap.timeline({ repeat: 1, yoyo: true, repeatDelay: 1 }).to(".type-text", {
      duration: 1.5,
    ...
    <div class="first-screen overflow-hidden">
      <div class="flex flex-col md:flex-row md:justify-between">
        <div>
          ...
          <h2 class="text-4xl md:text-6xl font-bold hero-text">
            I'm <span class="name">Mikan</span>
          </h2>
        ...
        <div
          class="flex flex-wrap flex-row gap-3 md:gap-0 md:flex-col md:pr-5"
          ref="linksDiv"
        >
          <div id="blog" class="hero-link">
            <a href="https://blog.bangdream.moe" class="super-link">Blog</a>
          </div>
          <div id="github" class="hero-link">
            <a href="https://github.com/mitian233" class="super-link">GitHub</a>
          </div>
          <div id="x" class="hero-link">
            <a href="https://x.com/mikan_chn" class="super-link">X/Twitter</a>
          </div>
        </div>
      </div>
      <div
        class="pt-5 pb-24 md:px-5 md:col-span-3 md:text-lg about-table"
        style="opacity: 0"
      >
        <table class="w-full border-separate">
          <tbody>
            <tr>
              ...
              <td class="md:text-justify">
                <p>
                  ...
                  <a
                    href="https://github.com/mitian233/astro-theme-akiba"
                    class="super-link"
                    >Akiba</a
                  >, Diving-fish's
                  <a
                    ...
                    >maimaidx prober</a
                  >
                  contributor and active member of
                  <a href="https://astro.build/" class="super-link">Astro</a>
                  community. I love developing useful tools :)
                </p>
                <p></p>
              </td>
            </tr>
            <tr>
              ...
              <td class="md:text-justify">
                <p>
                  Third-rate University student. Who's coding skills is all
                  self-taught. Excel at transforming design concepts into
                  responsive web applications. With a meticulous eye for detail
                  and a dedication to clean code, can actively contribute to
                  open-source projects, pushing the boundaries of web
                  development. Advocating for accessibility and usability, who
                  strive to create inclusive digital experiences. Committed to
                  collaboration, who stay updated on emerging technologies,
                  continually enhancing whose skills to make meaningful
                  contributions to the dynamic field of front-end development.
                </p>
              </td>
            </tr>
          </tbody>
