...
<div class="first-screen">
  <div class="flex flex-col md:flex-row md:justify-between">
    <div>
      <h1 class="text-4xl md:text-6xl font-bold">Hi</h1>
      <h2 class="text-4xl md:text-6xl font-bold">I'm <span class="name">Mikan</span></h2>
    ...
    <div class="flex flex-wrap flex-row gap-3 md:gap-0 md:flex-col md:pr-5">
      <div><a href="https://blog.bangdream.moe" class="super-link">Blog</a></div>
      <div><a href="https://github.com/mitian233" class="super-link">GitHub</a></div>
      <div><a href="https://x.com/mikan_chn" class="super-link">X/Twitter</a></div>
    </div>
  </div>
  <div class="py-5 md:px-5 md:col-span-3 md:text-lg">
